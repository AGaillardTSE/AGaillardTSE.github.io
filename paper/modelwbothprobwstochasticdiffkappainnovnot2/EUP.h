...
const char distVEwUI_0file[]="project_method/distVEwUI_0.out";
...
const char distVEwUI_Tfile[]="project_method/distVEwUI_T.out";
...
const char valueVEwUITfile[]="project_method/valueVEwUIT.out";
const char valueVEwUIcTfile[]="project_method/valueVEwUIcT.out";
...
const char valueVE0file[]="project_method/valueVE_0.out";
const char valueVEc0file[]="project_method/valueVEc_0.out";
const char valueVEwUI0file[]="project_method/valueVEwUI_0.out";
const char valueVEwUIc0file[]="project_method/valueVEwUIc_0.out";
const char valueWW10file[]="project_method/valueWW1_0.out";
const char valueWW00file[]="project_method/valueWW0_0.out";
const char valueUS00file[]="project_method/valueUS0_0.out";
const char valueUS10file[]="project_method/valueUS1_0.out";
const char valueUL00file[]="project_method/valueUL0_0.out";
const char valueUL10file[]="project_method/valueUL1_0.out";

const char saveVE_Tfile[]="project_method/saveVE_Tfile.out";
const char saveVEwUI_Tfile[]="project_method/saveVEwUI_Tfile.out";
const char saveWW1_Tfile[]="project_method/saveWW1_Tfile.out";
const char saveWW0_Tfile[]="project_method/saveWW0_Tfile.out";
const char saveUS1_Tfile[]="project_method/saveUS1_Tfile.out";
const char saveUL1_Tfile[]="project_method/saveUL1_Tfile.out";
const char saveUS0_Tfile[]="project_method/saveUS0_Tfile.out";
const char saveUL0_Tfile[]="project_method/saveUL0_Tfile.out";

const char CEVVE[]="project_method/CEVVE.out";
const char CEVall[]="project_method/CEVall.out";
const char VEILTfile[]="project_method/VEILT.out";
