...
void VFI(double *valueWW0, double *valueWW1, double *valueUS0, double *valueUS1, double *valueUL0, double *valueUL1, double *valueVE, double *valueVEc, double *valueVEwUI, double *valueVEwUIc, double *endoK,double *saveWW0, double *saveWW1, double *saveUS0, double *saveUS1, double *saveUL0, double *saveUL1, double *saveVE, double *saveVEwUI, double *searchEffortWWUS0, double *searchEffortWWUL0, double *searchEffortWWUS1, double *searchEffortVEUS1, double *searchEffortWWUL1, double *searchEffortVEUL1, double *searchEffortWWVE,double *searchEffortVEWW, double *searchEffortWWVEwUI)
{
   ...
   struct searchfendoKYY paramsKK;
...
#if indexPMwrite == 1
    // VALUE for projected methods:
    valuefnoutfile=fopen(valueVE0file, "w");
    setbuf ( valuefnoutfile , NULL );
    ...
    valuefnoutfile=fopen(valueVEwUI0file, "w");
    setbuf ( valuefnoutfile , NULL );
    ...
    valuefnoutfile=fopen(valueVEc0file, "w");
    setbuf ( valuefnoutfile , NULL );
    ...
    valuefnoutfile=fopen(valueVEwUIc0file, "w");
    setbuf ( valuefnoutfile , NULL );
    ...
    valuefnoutfile=fopen(valueWW10file, "w");
    setbuf ( valuefnoutfile , NULL );
    ...
    valuefnoutfile=fopen(valueWW00file, "w");
    setbuf ( valuefnoutfile , NULL );
    ...
    valuefnoutfile=fopen(valueUS10file, "w");
    setbuf ( valuefnoutfile , NULL );
    ...
    valuefnoutfile=fopen(valueUL10file, "w");
    setbuf ( valuefnoutfile , NULL );
    ...
    valuefnoutfile=fopen(valueUS00file, "w");
    setbuf ( valuefnoutfile , NULL );
    ...
    valuefnoutfile=fopen(valueUL00file, "w");
    setbuf ( valuefnoutfile , NULL );
...
//    fprintf(tempfileoutfile,"Nshare (US/US>E) %20.15f, \t Nshare(UL/UL>E): %20.15f, \t Nshare (U/U>E) : %20.15f\n",(necessityUStoVE)/(fracUStoVE), necessityULtoVE/(fracULtoVE), (necessityULtoVE + necessityUStoVE)/(fracUStoVE + fracULtoVE)); // 11th moment
    ...
    distoutfile=fopen(distVEwUI_Tfile, "w");
    setbuf ( distoutfile , NULL );
    ...
    for(int ygrid = 0; ygrid < maxprod ; ygrid++)
    {
        ...
        {
            for(egrid=0;egrid<maxfirmtype;egrid++) {
                fprintf(distoutfile,"%20.15f\n",distVEwUI[inxE(igrid, ygrid, egrid)]);
            }
        }
    }
    ...
    distoutfile=fopen(distVEwUI_0file, "w");
    setbuf ( distoutfile , NULL );
...
startingprice[0] = 0.062596094282829;        endprice[0] = 0.062594712912932;
startingprice[1] = 1.173091866791511;        endprice[1] = 1.173099301975617;
startingprice[2] = 0.011306767524860;        endprice[2] = 0.011306767508575;
startingprice[3] = 4.535904370356310;        endprice[3] = 4.538166660759145;
startingprice[4] = 0.842732180951385;        endprice[4] = 0.843137770321188;
startingprice[5] = 0.108965440248076;        endprice[5] = 0.109117416256638;
startingprice[6] = 0.053159327880998;        endprice[6] = 0.053151404131741;
...
double temp_EVWW0, temp_EVWW1, temp_EVUS0, temp_EVUL0, temp_EVUS1, temp_EVUL1, temp_CONSEVWW0, temp_CONSEVWW1, temp_CONSEVUS0, temp_CONSEVUL0, temp_CONSEVUS1, temp_CONSEVUL1, temp_EVVE, temp_CONSEVVE, *EVVE_T, *EVWW0_T, *EVWW1_T, *EVUS0_T, *EVUL0_T, *EVUS1_T, *EVUL1_T, *EVVEwUI_T;
double temp_EVWW0_SS, temp_EVWW1_SS, temp_EVUS0_SS, temp_EVUL0_SS, temp_EVUS1_SS, temp_EVUL1_SS, temp_CONSEVWW0_SS, temp_CONSEVWW1_SS, temp_CONSEVUS0_SS, temp_CONSEVUL0_SS, temp_CONSEVUS1_SS,temp_CONSEVUL1_SS , *EVWW0_SS, *EVWW1_SS, *EVUS0_SS, *EVUL0_SS, *EVUS1_SS, *EVUL1_SS, temp_EVVE_SS,temp_CONSEVVE_SS, *EVVE_SS, *EVVEwUI_SS;

EVVE_T = (double *) calloc((ifulldimE), sizeof(double));
EVVEwUI_T = (double *) calloc((ifulldimE), sizeof(double));
...
EVVEwUI_SS = (double *) calloc((ifulldimE), sizeof(double));
...
double *valueVE0, *valueVEwUI0, *valueVEwUIc0, *valueWW10, *valueWW00, *valueUS10, *valueUL10, *valueUS00, *valueUL00, *valueVEc0;
valueVE0 = (double *) calloc((ifulldimE), sizeof(double));
valueVEc0 = (double *) calloc((ifulldimE), sizeof(double));
valueVEwUI0 = (double *) calloc((ifulldimE), sizeof(double));
valueVEwUIc0 = (double *) calloc((ifulldimE), sizeof(double));
...
readinput(valueVEwUI0, ifulldimE, "project_method/valueVEwUI_0.out");
readinput(valueVEwUIc0, ifulldimE, "project_method/valueVEwUIc_0.out");
...
double *saveVE_T, *saveVEwUI_T, *saveWW0_T, *saveWW1_T, *saveUL0_T, *saveUS0_T, *saveUS1_T, *saveUL1_T;
saveVE_T = (double *) calloc((ifulldimE), sizeof(double));
saveVEwUI_T = (double *) calloc((ifulldimE), sizeof(double));
...
readinput(saveVEwUI_T, ifulldimE, "project_method/saveVEwUI_Tfile.out");
...
double *valueVET, *valueVEwUIcT, *valueVEwUIT, *valueWW1T, *valueWW0T, *valueUS1T, *valueUL1T, *valueUS0T, *valueUL0T, *valueVEcT;
valueVET = (double *) calloc((ifulldimE), sizeof(double));
valueVEcT = (double *) calloc((ifulldimE), sizeof(double));
valueVEwUIT = (double *) calloc((ifulldimE), sizeof(double));
valueVEwUIcT = (double *) calloc((ifulldimE), sizeof(double));
...
readinput(valueVEwUIT, ifulldimE, "project_method/valueVEwUIT.out");
readinput(valueVEwUIcT, ifulldimE, "project_method/valueVEwUIcT.out");
...
double *distVE_T, *distVEwUI_T, *distWW1_T, *distWW0_T, *distUL0_T, *distUL1_T, *distUS1_T, *distUS0_T;
distVE_T = (double *) calloc((ifulldimE), sizeof(double));
distVEwUI_T = (double *) calloc((ifulldimE), sizeof(double));
...
readinput(distVEwUI_T, ifulldimE, "project_method/distVEwUI_T.out");
...
double *distVE_0, *distVEwUI_0, *distWW1_0, *distWW0_0, *distUL0_0, *distUL1_0, *distUS1_0, *distUS0_0;
distVE_0 = (double *) calloc((ifulldimE), sizeof(double));
distVEwUI_0 = (double *) calloc((ifulldimE), sizeof(double));
...
readinput(distVEwUI_0, ifulldimE, "project_method/distVEwUI_0.out");
...
double *saveVE, *saveVEwUI, *saveWW1, *saveWW0, *saveUS1, *saveUL1, *saveUS0, *saveUL0, *searchWW1, *searchVE, *searchEffortVEWW, *searchEffortWWVE, *searchEffortWWUS1, *searchEffortVEUS1, *searchEffortWWUL1, *searchEffortVEUL1, *searchEffortWWUS0 , *searchEffortWWUL0, *searchEffortWWVEwUI;

saveVE = (double *) calloc((ifulldimE*T), sizeof(double));
saveVEwUI = (double *) calloc((ifulldimE*T), sizeof(double));
...
searchEffortWWVEwUI = (double *) calloc((ifulldimE*T), sizeof(double));
...
double *temp_saveVE, *temp_saveVEwUI, *temp_saveWW1, *temp_saveWW0, *temp_saveUS1, *temp_saveUL1, *temp_saveUS0, *temp_saveUL0, *temp_searchEffortVEWW, *temp_searchEffortWWVE, *temp_searchEffortWWUS1, *temp_searchEffortVEUS1, *temp_searchEffortWWUL1 , *temp_searchEffortVEUL1 , *temp_searchEffortWWUS0, *temp_searchEffortWWUL0, *temp_searchEffortWWVEwUI;

temp_saveVE = (double *) calloc((ifulldimE), sizeof(double));
temp_saveVEwUI = (double *) calloc((ifulldimE), sizeof(double));
...
temp_searchEffortWWVEwUI = (double *) calloc((ifulldimE), sizeof(double));
...
double *valueVE, *valueVEwUI, *valueVEwUIc, *valueWW1, *valueWW0, *valueUS1, *valueUL1, *valueUL0,  *valueUS0, *valueVEc;

valueVE = (double *) calloc((ifulldimE*T), sizeof(double));
valueVEc = (double *) calloc((ifulldimE*T), sizeof(double));
valueVEwUI = (double *) calloc((ifulldimE*T), sizeof(double));
valueVEwUIc = (double *) calloc((ifulldimE*T), sizeof(double));
...
double *temp_valueVE, *temp_valueVEwUI, *temp_valueVEwUIc, *temp_valueWW1, *temp_valueWW0, *temp_valueUS1, *temp_valueUL1, *temp_valueUS0, *temp_valueUL0, *temp_valueVEc;

temp_valueVE = (double *) calloc((ifulldimE), sizeof(double));
temp_valueVEc = (double *) calloc((ifulldimE), sizeof(double));
temp_valueVEwUI = (double *) calloc((ifulldimE), sizeof(double));
temp_valueVEwUIc = (double *) calloc((ifulldimE), sizeof(double));
...
double *distVE,*distVEwUI, *distWW1, *distWW0, *distUL1, *distUL0, *distUS0, *distUS1;

distVE = (double *) calloc((ifulldimE*T), sizeof(double));
distVEwUI = (double *) calloc((ifulldimE*T), sizeof(double));
...
double *temp_distVE,*temp_distVEwUI, *temp_distWW1, *temp_distWW0, *temp_distUL1, *temp_distUL0, *temp_distUS0, *temp_distUS1;

temp_distVE = (double *) calloc((ifulldimE), sizeof(double));
temp_distVEwUI = (double *) calloc((ifulldimE), sizeof(double));
...
double *temp_distVEnext, *temp_distVEwUInext, *temp_distWW1next, *temp_distWW0next, *temp_distUL1next, *temp_distUL0next, *temp_distUS0next, *temp_distUS1next;

temp_distVEnext = (double *) calloc((ifulldimE), sizeof(double));
temp_distVEwUInext = (double *) calloc((ifulldimE), sizeof(double));
...
bascule2E(valueVEwUIT,valueVEwUI,(T-1));
bascule2E(valueVEwUIcT, valueVEwUIc,(T-1));
...
bascule2E(distVEwUI_0, distVEwUI, 0);
...
bascule(valueVEwUIT, temp_valueVEwUI, ifulldimE);
bascule(valueVEwUIcT, temp_valueVEwUIc, ifulldimE);
...
bascule(distVEwUI_0, temp_distVEwUI, ifulldimE);
...
printf("POLICY VALUE STARTING\n");
    ...
    for(int ii = 1; ii < T;  ii++) {
        ...
        VFI(temp_valueWW0, temp_valueWW1, temp_valueUS0, temp_valueUS1, temp_valueUL0, temp_valueUL1, temp_valueVE, temp_valueVEc, temp_valueVEwUI, temp_valueVEwUIc, endoK, temp_saveWW0, temp_saveWW1, temp_saveUS0, temp_saveUS1, temp_saveUL0, temp_saveUL1, temp_saveVE, temp_saveVEwUI, temp_searchEffortWWUS0, temp_searchEffortWWUL0, temp_searchEffortWWUS1, temp_searchEffortVEUS1, temp_searchEffortWWUL1, temp_searchEffortVEUL1, temp_searchEffortWWVE, temp_searchEffortVEWW, temp_searchEffortWWVEwUI);
        ...
        bascule2E(temp_valueVEwUI,valueVEwUI,(T-1-ii));
        bascule2E(temp_valueVEwUIc,valueVEwUIc,(T-1-ii));
        ...
        bascule2E(temp_searchEffortWWVEwUI,searchEffortWWVEwUI,(T-1-ii));
        ...
        bascule2E(temp_saveVEwUI,saveVEwUI,(T-1-ii));
...
printf("\nSTARTING DISTRIBUTION...\n");
    ...
    for(int jj = 0; jj < (T); jj++) {
        ...
        bascule3E(valueVEwUI,temp_valueVEwUI,(jj+1));
        bascule3E(valueVEwUIc,temp_valueVEwUIc,(jj+1));
        ...
        bascule3E(valueVEwUI,temp_valueVEwUI,(jj));
        bascule3E(valueVEwUIc,temp_valueVEwUIc,(jj));
        ...
        bascule3E(searchEffortWWVEwUI, temp_searchEffortWWVEwUI, jj);
        ...
        bascule3E(saveVEwUI, temp_saveVEwUI, jj);
...
//        printf("I am here");getchar();
        ...
        SIMULATION(temp_valueWW0, temp_valueWW1, temp_valueUS0, temp_valueUS1, temp_valueUL0, temp_valueUL1, temp_valueVE, temp_valueVEc, temp_valueVEwUI, temp_valueVEwUIc, endoK, temp_saveWW0, temp_saveWW1, temp_saveUS0, temp_saveUS1, temp_saveUL0, temp_saveUL1, temp_saveVE, temp_saveVEwUI, temp_searchEffortWWUS0, temp_searchEffortWWUL0, temp_searchEffortWWUS1, temp_searchEffortVEUS1, temp_searchEffortWWUL1, temp_searchEffortVEUL1, temp_searchEffortWWVE, temp_searchEffortVEWW, temp_searchEffortWWVEwUI, &capitalout, &laborout, &taxout, genmoments, temp_distVE, temp_distWW1, temp_distWW0, temp_distUL0, temp_distUL1, temp_distUS1, temp_distUS0, temp_distVEwUI,  temp_distVEnext, temp_distVEwUInext, temp_distWW1next, temp_distWW0next, temp_distUL0next, temp_distUL1next, temp_distUS1next, temp_distUS0next, &fracVE, &fracU);
        ...
        bascule(temp_distVEwUInext, temp_distVEwUI, ifulldimE);
...
//            printf("%f %f %f", relaxTP, pricepath[inxPrice(ii,jj)], nowpricepath[inxPrice(ii,jj)]);getchar();
    ...
    for(int ygrid = 0; ygrid < maxprod ; ygrid++)
    {
        ...
        EVUL1_T[inx(igrid,ygrid)] = 0.0;
            ...
            for(int egrid=0;egrid<maxfirmtype;egrid++) {
                ...
                temp_VALA += distVEwUI_0[inxE(igrid,ygrid, egrid)]*valueVEwUI0[inxE(igrid,ygrid, egrid)];
                temp_VALB += distVEwUI_T[inxE(igrid,ygrid, egrid)]*valueVEwUIT[inxE(igrid,ygrid, egrid)];
                EVVEwUI_SS[inxE(igrid,ygrid, egrid)] =  pow((valueVEwUIT[inxE(igrid,ygrid, egrid)]/valueVEwUI0[inxE(igrid,ygrid, egrid)]),(1/(1-sigmapar))) - 1;

                
                EVVE_T[inxE(igrid,ygrid, egrid)] = 0.0;
                EVVEwUI_T[inxE(igrid,ygrid, egrid)] = 0.0;
            }
        ...
        for(int ygrid = 0; ygrid < maxprod ; ygrid++)
        {
            ...
            EVUL1_T[inx(igrid,ygrid)] += pow((valueUL1[inxTP((T-2-ii), igrid, ygrid)]/valueUL1[inxTP((T-1-ii), igrid, ygrid)]),(1/(1-sigmapar))) - 1;
                ...
                for(int egrid=0;egrid<maxfirmtype;egrid++) {
                    ...
                    temp_VALA_T += distVEwUI[inxTP((T-2-ii), igrid, ygrid)]*valueVEwUI[inxTPE((T-2-ii), igrid, ygrid, egrid)];
                    temp_VALB_T += distVEwUI[inxTP((T-1-ii), igrid, ygrid)]*valueVEwUI[inxTPE((T-1-ii), igrid, ygrid, egrid)];
                    EVVEwUI_T[inxE(igrid,ygrid, egrid)] += pow((valueVEwUI[inxTPE((T-2-ii), igrid, ygrid, egrid)]/valueVEwUI[inxTPE((T-1-ii), igrid, ygrid, egrid)]),(1/(1-sigmapar))) - 1;
                }
    ...
    fprintf(pricefile,"%20s\t%5s\t%5s\t%20s\t%20s\t%20s\t%20s\t%20s\t%20s\n","ASSET","TYPE", "PROD", "distVE", "SSVE", "TVE", "distVEwUI", "SSVEwUI", "TVEwUI");
    ...
    for(int ygrid = 0; ygrid < maxprod ; ygrid++)
    {
        ...
        {
            for(int egrid=0;egrid<maxfirmtype;egrid++) {
               fprintf(pricefile,"%20.15f\t%5d\t%5d\t%20.15f\t%20.15f\t%20.15f\t%20.15f\t%20.15f\t%20.15f\n",grid[igrid], egrid, ygrid, distVE_T[inxE(igrid, ygrid,egrid)],EVVE_SS[inxE(igrid, ygrid,egrid)], EVVE_T[inxE(igrid, ygrid,egrid)], distVEwUI_T[inxE(igrid, ygrid,egrid)],EVVEwUI_SS[inxE(igrid, ygrid,egrid)], EVVEwUI_T[inxE(igrid, ygrid,egrid)]);
            }
